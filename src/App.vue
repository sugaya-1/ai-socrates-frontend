<script setup>
// QuestionFetcherコンポーネントをインポート
import QuestionFetcher from './components/QuestionFetcher.vue';
</script>
...
<style>
/* Vue/Tailwindプロジェクトの基本スタイル。Tailwindがクラスを適用します。 */
/* App.vueでTailwindのクラスを使用するために、このファイルに特別なCSSは不要です。 */
</style>
